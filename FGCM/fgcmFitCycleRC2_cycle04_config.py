...
config.expGrayPhotometricCutDict={'g': -0.015, 'r': -0.005, 'i': -0.0075, 'z': -0.01, 'N921': -0.025, 'y': -0.0125}
...
config.expGrayHighCutDict={'g': 0.02, 'r': 0.01, 'i': 0.0125, 'z': 0.015, 'N921': 0.035, 'y': 0.0175}
...
config.connections.previousCycleNumber='3'

# Template parameter used to format corresponding field template parameter
config.connections.cycleNumber='4'
