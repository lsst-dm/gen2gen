...
config.expGrayPhotometricCutDict={'g': -0.03, 'r': -0.0125, 'i': -0.015, 'z': -0.055, 'N921': -0.0575, 'y': -0.025}
...
config.expGrayHighCutDict={'g': 0.045, 'r': 0.0175, 'i': 0.0275, 'z': 0.0775, 'N921': 0.075, 'y': 0.0425}
...
config.connections.previousCycleNumber='0'

# Template parameter used to format corresponding field template parameter
config.connections.cycleNumber='1'
